...
for i = 1:5
    if i == 1
        string = [string1 string3 string9];
    end
    if i == 2
        string = [string1 string4 string5 string9];
        string_extra = [string1 string4 string5 string10 string9];
    end
    if i == 3
        string = [string1 string4 string5 string6 string9];
        string_extra = [string1 string4 string5 string6 string10 string9];
    end
    if i == 4
        string = [string1 string4 string5 string6 string7 string9];
        string_extra = [string1 string4 string5 string6 string7 string10 string9];
    end
    if i == 5
        string = [string1 string4 string5 string6 string7 string8 string9];
